...
function censorMessage(sentence,censorList){
let rawWords = sentence.split(" ")
let scrubbedWords = []

rawWords.forEach((eachWord)=>{
let lowercaseWord = eachWord.toLowerCase()

if (censorList.includes(lowercaseWord)){
  scrubbedWords.push("*****")
} else {
